...
int main(int argc, char * argv[])
{
	...
	auto node = std::make_shared<rclcpp::Node>("can_receiver_can0");
	auto pub1 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_1_can0", 10);
    auto pub2 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_2_can0", 10);
    auto pub3 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_3_can0", 10);
    auto pub4 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_4_can0", 10);
    auto pub5 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_5_can0", 10);
    auto pub6 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_6_can0", 10);
    auto pub7 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_7_can0", 10);
    auto pub8 = node->create_publisher<robomas_package_2::msg::MotorFeedback>("motor_rx_8_can0", 10);

    auto pub_can_ = node->create_publisher<robomas_package_2::msg::CanFrame>("can_frame_rx_can0", 10);
